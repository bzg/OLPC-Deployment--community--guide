...
- Wiki d'OLPC : http://wiki.laptop.org
- Wiki de ce guide de déploiement [[http://wiki.laptop.org/go/Deployment_Guide][en anglais]]
- Guide de l'ordinateur [[http://olpc-france.org/docs/OLPC%2520Guide%2520de%2520l'ordinateur.pdf][en français]]
- Guide Sugar, en page web ou en pdf sur [[http://en.flossmanuals.net/Sugar][Flossmanuals]]
- Forum officiel de la communauté de support d'OLPC
- Foire aux Questions : http://wiki.laptop.org/go/Support_FAQ
- [[http://wiki.sugarlabs.org/][Wiki]] de [[http://sugarlabs.org/][Sugar Labs]], qui fournit l'environnement Sugar et les activités

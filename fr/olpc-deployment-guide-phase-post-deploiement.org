...
- Section suivante : [[file:olpc-deployment-guide-resume-taches.org][Résumé des tâches recommandées]]
- Section précédente : [[file:olpc-deployment-guide-phase-de-deploiement.org][Phase de déploiement]]
